...
const MOVIE_PICKS = [
  // 기예르모 델 토로
  '판의 미로','셰이프 오브 워터','크림슨 피크','헬보이','헬보이 2: 골든 아미','피노키오',
  // 알폰소 쿠아론
  '그래비티','로마','이 투 마마','칠드런 오브 맨','해리포터와 아즈카반의 죄수',
  // 알레한드로 곤잘레스 이냐리투
  '버드맨','레버넌트: 죽음에서 돌아온 자','바벨','비우티풀','21그램',
  // 디즈니 · 픽사
  '토이 스토리','월-E','업','라따뚜이','인사이드 아웃','소울','코코','루카','엘리멘탈',
  '인크레더블','니모를 찾아서','도리를 찾아서','몬스터 주식회사','인사이드 아웃 2',
  '주토피아','겨울왕국','모아나','라푼젤','빅 히어로','주먹왕 랄프','엔칸토',
  '알라딘','라이온 킹','미녀와 야수','뮬란','포카혼타스','노트르담의 꼽추',
  // 기타 추천
  '기생충','올드보이','인터스텔라','라라랜드','어바웃 타임','매트릭스','인셉션',
  '그랜드 부다페스트 호텔','시네마 천국','너의 이름은','센과 치히로의 행방불명',
  '마녀 배달부 키키','하울의 움직이는 성','원스','500일의 썸머','노팅 힐',
  '비포 선라이즈','이터널 선샤인','미드나잇 인 파리','어바웃 어 보이',
  '어벤져스: 엔드게임','해리포터와 마법사의 돌','하이큐!! 극장판','스파이더맨: 뉴 유니버스'
];
